...
def speed_dA(learning_rate=0.1, training_epochs=15,
            batch_size=10):
    trainNum = 660
    featureNum = 10

    train_set_x = numpy.zeros([trainNum, featureNum])

    speed = pd.read_csv('D:\Study\Project\Python\wind-speed-forecasting_v1\data\G4_speed.csv')
    for i in range(trainNum):
        train_set_x[i, :] = speed.iloc[i:(i + 10), 1]
    ...
    numpy.save('D:\Study\Project\Python\wind-speed-forecasting_v1\data\G4_highlevel.npy',c)
    # print(c)
